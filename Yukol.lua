...
WindUI:Popup({
    Title = CreateGradientText("Scripts.SM", Colors.Red, Colors.Green),
    Icon = "skull",
...
local Window = WindUI:CreateWindow({
    Title = CreateGradientText("Scripts.SM | Murder Mystery 2", Colors.Red, Colors.Green),
    Author = "by discord.gg/SnXQCYzGjx ",
    Folder = "Kuni Hb",
    Icon = "skull",
    NewElements = true,
...
local MainSection = Window:Section({
    Title = CreateGradientText("Scripts.SM", Colors.Pumpkin, Colors.Purple),
    Icon = "flame",
    Opened = true,
})
